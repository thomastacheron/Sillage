...
void sivia(IntervalVector& map, ibex::Sep& Sep, double epsilon)
{
    ...
    while(!s.empty())
    {
        ...
        {
            vibes::drawBox(box[0].lb(),box[0].ub(), box[1].lb(),box[1].ub(), "#009E73[#56B4E9]");
        }
        else if (boxIn[0].is_empty() && boxIn[1].is_empty())
        {
            vibes::drawBox(box[0].lb(),box[0].ub(), box[1].lb(),box[1].ub(), "grey[white]");
        }
        else
        {
            ...
            {
                vibes::drawBox(box[0].lb(),box[0].ub(),box[1].lb(),box[1].ub(),"#D55E00[#CC79A7]");
...
void sivia(IntervalVector& map, ibex::Ctc& Ctc, double epsilon)
{
